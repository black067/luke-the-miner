...
export interface GameStateObj { screen: string; settingsReturn: string; isNewGame: boolean; debt: number; bitcoin: number; cash: number; selectedArea: string; combatResult: string | null; battlesCompleted: number; equipment: Equipment; quickBar: QuickBarSlot[]; warehouse: WarehouseItem[]; upgrades: Set<string>; unlocks: Unlocks; mailsRead: Record<string, boolean>; settings: GameSettings; audio: AudioState; }
